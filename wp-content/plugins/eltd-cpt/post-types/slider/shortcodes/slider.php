...
namespace ElatedCPT\CPT\Slider\Shortcodes;

use ElatedCPT\Lib;

/**
 * Class Slider
 * @package ElatedCPT\CPT\Slider\Shortcodes
 */
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if ($slider_parallax == 'no' || (isset($eltd_moose_options['paspartu']) && $eltd_moose_options['paspartu'] == 'yes' && (isset($eltd_moose_options['paspartu_on_top']) && $eltd_moose_options['paspartu_on_top'] == 'yes' && $eltd_moose_options['paspartu_on_top_fixed'] == 'no'))) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                ...
                if(isset($eltd_moose_options['vertical_area']) && $eltd_moose_options['vertical_area'] =='yes' && isset($eltd_moose_options['paspartu']) && $eltd_moose_options['paspartu'] == 'yes') {
                    $slider_thumbs = 'no';
                }
            }
            ...
            if (isset($eltd_moose_options['header_background_transparency_initial']) && $eltd_moose_options['header_background_transparency_initial'] != "1" && $eltd_moose_options['header_background_transparency_initial'] != "") {
            ...
            if (isset($eltd_moose_options['navigation_button_height']) && $eltd_moose_options['navigation_button_height'] != '') {
                $arrow_button_height = esc_attr($eltd_moose_options['navigation_button_height']);
            }
            ...
            if (isset($eltd_moose_options['enable_manu_item_border']) && $eltd_moose_options['enable_manu_item_border'] == 'yes' && isset($eltd_moose_options['menu_item_style']) && $eltd_moose_options['menu_item_style'] == 'large_item') {
                if (isset($eltd_moose_options['menu_item_border_style']) && $eltd_moose_options['menu_item_border_style'] == 'all_borders') {
                    $large_menu_item_border = esc_attr($eltd_moose_options['menu_item_border_width']) * 2;
                }
                if (isset($eltd_moose_options['menu_item_border_style']) && $eltd_moose_options['menu_item_border_style'] == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr($eltd_moose_options['menu_item_border_width']) * 2;
                }
                if (isset($eltd_moose_options['menu_item_border_style']) && $eltd_moose_options['menu_item_border_style'] == 'bottom_border') {
                    $large_menu_item_border = esc_attr($eltd_moose_options['menu_item_border_width']);
                }
            }
            ...
            if (isset($eltd_moose_options['header_bottom_appearance'])) {
                switch ($eltd_moose_options['header_bottom_appearance']) {
                    case 'stick':
                        $logo_height = esc_attr($eltd_moose_options['logo_height']) / 2;
                        break;
                    ...
                    case 'fixed_hiding':
                        ...
                        break;
                    case 'regular':
                    	if (isset($eltd_moose_options['center_logo_image']) && $eltd_moose_options['center_logo_image'] == "yes"){
                        	$logo_height = esc_attr($eltd_moose_options['logo_height']) / 2;
                    	}
                    	else {
                        	$logo_height = esc_attr($eltd_moose_options['logo_height']);
                    	}
                    	break;
                    default:
                        $logo_height = esc_attr($eltd_moose_options['logo_height']);
            ...
            if ((get_post_meta($page_id, "eltd_header_color_transparency_per_page", true) !== "0") && ($eltd_moose_options['header_background_transparency_initial'] !== "0") && ((isset($eltd_moose_options['paspartu']) && $eltd_moose_options['paspartu'] == 'no') || (isset($eltd_moose_options['paspartu_on_top']) && $eltd_moose_options['paspartu_on_top'] == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if ((isset($eltd_moose_options['center_logo_image']) && $eltd_moose_options['center_logo_image'] == "yes" && $eltd_moose_options['header_bottom_appearance'] !== 'stick menu_bottom' && $eltd_moose_options['header_bottom_appearance'] !== 'stick_with_left_right_menu') || $eltd_moose_options['header_bottom_appearance'] == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if(isset($eltd_moose_options['qs_enable_navigation_custom_cursor']) && ($eltd_moose_options['qs_enable_navigation_custom_cursor']=="yes")){
                $custom_cursor = "has_custom_cursor";
            }

            if((isset($eltd_moose_options['paspartu']) && $eltd_moose_options['paspartu'] == 'yes' && (isset($eltd_moose_options['paspartu_on_top']) && $eltd_moose_options['paspartu_on_top'] == 'yes' && $eltd_moose_options['paspartu_on_top_fixed'] == 'no')) || $slider_parallax == "no"){
            ...
            $ajax_loader = '';
            if($eltd_moose_options['loading_animation'] == "on") {
                if($eltd_moose_options['loading_image'] != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url($eltd_moose_options['loading_image']) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . eltd_moose_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="eltd-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.eltd_moose_get_inline_style($slide_holder_height. $background_color).'><div class="eltd_slider_preloader" '.eltd_moose_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.eltd_moose_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            query_posts($args);
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $thumbnail_attributes = eltd_moose_get_attachment_meta_from_url($thumbnail, array('width','height'));
					...
					if (get_post_meta(get_the_ID(), "eltd_slide_text_content_top_margin", true) != "") {
                        $slide_content_style .= "margin-top: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_text_content_top_margin", true)) . "px;";
                    }
					if (get_post_meta(get_the_ID(), "eltd_slide_text_content_bottom_margin", true) != "") {
                        $slide_content_style .= "margin-bottom: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_text_content_bottom_margin", true)) . "px;";
                    }
					
					if (get_post_meta(get_the_ID(), "eltd_slide_text_content_box_shaddow", true) != "") {
                        $slide_content_style .= "box-shadow: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_text_content_box_shaddow", true)) . ";";
                    }
					
					$slide_content_inner_shaddow="";
					if (get_post_meta(get_the_ID(), "eltd_slide_content_graphic_box_shaddow", true) != "") {
                        $slide_content_inner_shaddow .= "box-shadow: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_content_graphic_box_shaddow", true)) . ";";
                    }
					
					$slide_content_inner_background="";
					if (get_post_meta(get_the_ID(), "eltd_slide_content_graphic_background", true) != "") {
                        $slide_content_inner_background .= "background-color: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_content_graphic_background", true)) . ";";
                    }
					...
					$slide_graphic_style = "";
                    if (get_post_meta(get_the_ID(), "eltd_slide_graphic_background", true) != "") {
                        $slide_graphic_style .= "background-color: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_graphic_background", true)) . ";";
                    }
					if (get_post_meta(get_the_ID(), "eltd_slide_graphic_top_padding", true) != "") {
                        $slide_graphic_style .= "padding-top: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_graphic_top_padding", true)) . "px;";
                    }
					if (get_post_meta(get_the_ID(), "eltd_slide_graphic_bottom_padding", true) != "") {
                        $slide_graphic_style .= "padding-bottom: " . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_graphic_bottom_padding", true)) . "px;";
                    }
                    $slide_title_style = "";
                    ...
                    if (get_post_meta(get_the_ID(), 'eltd_slide-title-background-color', true) !== '') {
                        ...
                        $slide_title_span_style .= 'background-color: ' . esc_attr(eltd_moose_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . ';';
                    }
                        ...
                        if ($slide_separator_type_var == "without_icon") {
                            ...
                            if ($slide_separator_color !== '') {
                                ...
                                if ($slide_separator_transparency !== '') {
                                    ...
                                    $slide_separator_rgba_color = eltd_moose_rgba_color($slide_separator_color, $slide_separator_transparency);
                    ...
                    if (get_post_meta(get_the_ID(), 'eltd_slide-subtitle-background-color', true) !== '') {
                        ...
                        $slide_subtitle_span_style .= 'background-color: ' . esc_attr(eltd_moose_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . ';';
                    }
					...
					if (get_post_meta(get_the_ID(),'slide_subtitle_like_separator',true) == 'yes'){
						if (get_post_meta(get_the_ID(),'slide_subtitle_separator_color',true) !== ''){
							$slide_subtitle_separator_style .= 'border-bottom-color: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_color',true).';';
						}
						if (get_post_meta(get_the_ID(),'slide_subtitle_separator_transparency',true) !== ''){
							$slide_subtitle_separator_style .= 'opacity: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_transparency',true).';';
						}
						if (get_post_meta(get_the_ID(),'slide_subtitle_separator_width',true) !== ''){
							$slide_subtitle_separator_style .= 'width: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_width',true).'%;';
						}
						if (get_post_meta(get_the_ID(),'slide_subtitle_separator_thickness',true) !== ''){
							$slide_subtitle_separator_style .= 'border-bottom-width: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_thickness',true).'px;';
						}
						if (get_post_meta(get_the_ID(),'slide_subtitle_separator_style',true) !== ''){
							$slide_subtitle_separator_style .= 'border-bottom-style: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_style',true).';';
						}
					}
					$subtitle_left_sep_margin = "";
					$subtitle_right_sep_margin = "";
					if (get_post_meta(get_the_ID(),'slide_subtitle_separator_margin',true) !== ''){
						$subtitle_left_sep_margin .= 'margin-right: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_margin',true).'px;';
					}
					if (get_post_meta(get_the_ID(),'slide_subtitle_separator_margin',true) !== ''){
						$subtitle_right_sep_margin .= 'margin-left: '.get_post_meta(get_the_ID(),'slide_subtitle_separator_margin',true).'px;';
					}
					$slide_subtitle_separator_position = "both";
					if (get_post_meta(get_the_ID(),'slide_subtitle_separator_position',true) !== ''){
						$slide_subtitle_separator_position = get_post_meta(get_the_ID(),'slide_subtitle_separator_position',true);
					}
                    ...
                    if ($slide_text_separator_var == "no") {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide-text-background-color', true) !== '') {
                            ...
                            $slide_text_span_style .= 'background-color: ' . esc_attr(eltd_moose_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . ';';
                        }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-content-full-width", true) == "yes" && get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "no") {
                        $content_full_width_class = "slide_full_width";
                    }else if(get_post_meta(get_the_ID(), "eltd_slide_vertical_content_full_width", true) == "yes" && get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
						$content_full_width_class = "slide_full_width";
					}
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes" && $content_predefined_position == "") {
						...
						if(get_post_meta(get_the_ID(), "eltd_slide_vertical_content_width", true) != ""){
							$vertical_content_width = "width:" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_vertical_content_width", true)) . "%; position:relative; ";
						}
						if (get_post_meta(get_the_ID(), "eltd_slide_vertical_content_left", true) != "") {
                            $vertical_content_xaxis = "left:" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_vertical_content_left", true)) . "%;";
                        }else if (get_post_meta(get_the_ID(), "eltd_slide_vertical_content_right", true) != "") {
                                $vertical_content_xaxis = "right:" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide_vertical_content_right", true)) . "%;";
                        }
                    } else {
                        if($content_predefined_position != ""){
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide_predefined_content_position_width_fs", true) !== "") {
                        $slide_data_content_resize = 'data-resize = '.esc_attr(get_post_meta(get_the_ID(), "eltd_slide_predefined_content_position_width_fs", true));
                    }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.eltd_moose_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.eltd_moose_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.eltd_moose_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="eltd_slide_subtitle" '.eltd_moose_get_inline_style($slide_subtitle_style).'>';
						if ($slide_subtitle_separator_style !== '' && ($slide_subtitle_separator_position == 'both' || $slide_subtitle_separator_position == 'left')){
							$html_text .= '<span class="separator" '.eltd_moose_get_inline_style($slide_subtitle_separator_style.' '.$subtitle_left_sep_margin).' ></span>';
						}
						$html_text .= '<span '.eltd_moose_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'eltd_slide-subtitle', true)) . '</span>';
						if ($slide_subtitle_separator_style !== '' && ($slide_subtitle_separator_position == 'both' || $slide_subtitle_separator_position == 'right')){
							$html_text .= '<span class="separator" '.eltd_moose_get_inline_style($slide_subtitle_separator_style.' '.$subtitle_right_sep_margin).' ></span>';
						}
                        $html_text .= '</h3>';
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ((get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.eltd_moose_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="eltd_slide_title" '.eltd_moose_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.eltd_moose_get_inline_style($slide_separator_styles.$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.eltd_moose_get_inline_style($slide_dots_style).'></span></span>';
                        }
                        if (get_post_meta(get_the_ID(), "eltd_slide-title-link", true) != '') {
                            $html_text .= '<a '.eltd_moose_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.eltd_moose_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "eltd_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.eltd_moose_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.eltd_moose_get_inline_style($slide_dots_style).'></span></span>';
                        }
                    ...
                    if ((get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.eltd_moose_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="eltd_slide_text" '.eltd_moose_get_inline_style($slide_text_style).'><span '.eltd_moose_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "eltd_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-button_border_color", true) != "") {
						...
						$icon_span_border1 .= "border-color:" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button_border_color", true)) . ";";
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color", true) != "" && get_post_meta(get_the_ID(), "eltd_slide-button1_hover_button_animation", true) == '' ) {
                        $data_attr1 .= "data-hover-background-color=" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color", true)) . " ";
                    }
					if (get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color", true) != "" && get_post_meta(get_the_ID(), "eltd_slide-button1_hover_button_animation", true) !== '' ) {
                        $data_attr1 .= "data-hover-animated-background-color=" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color", true)) . " ";
                    }
                    ...
                    if ($is_first_button_shown) {
						...
						$first_button_class='';
						if(get_post_meta(get_the_ID(), "eltd_slide-button1_hover_button_animation", true) !== '') {
                            $first_button_class = esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button1_hover_button_animation", true));
							$first_button_class .= ' animate_button';
							
                        }
						
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_icon_class) . esc_attr($first_button_class).'" ' . $data_attr1 . ' '.eltd_moose_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '"><span class="text_holder"><span class="a_overlay"></span><span>' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label", true)) . '</span><span class="hidden_text">' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label", true)) . '</span></span><span class="icon_holder" '.eltd_moose_get_inline_style($icon_span_border1).'><span>' . $first_button_icon_html . '</span><span class="hidden_icon">' . $first_button_icon_html . '</span></span></a>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-button_border_color2", true) != "") {
						...
						$icon_span_border2 .= "border-color:" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button_border_color2", true)) . ";";
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color2", true) != "" && get_post_meta(get_the_ID(), "eltd_slide-button2_hover_button_animation", true) == '') {
                        $data_attr2 .= "data-hover-background-color=" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color2", true)) . " ";
                    }
					if (get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color2", true) != "" && get_post_meta(get_the_ID(), "eltd_slide-button2_hover_button_animation", true) !== '' ) {
                        $data_attr2 .= "data-hover-animated-background-color=" . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button_background_hover_color2", true)) . " ";
                    }
                    ...
                    if ($is_second_button_shown) {
						...
						$second_button_class='';
						if(get_post_meta(get_the_ID(), "eltd_slide-button2_hover_button_animation", true) !== '') {
                            $second_button_class = esc_attr(get_post_meta(get_the_ID(), "eltd_slide-button2_hover_button_animation", true));
							$second_button_class .= ' animate_button';
                        }
	
						
						$html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class) . esc_attr($second_button_class).'" ' . $data_attr2 . ' '.eltd_moose_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '"><span class="text_holder"><span class="a_overlay"></span><span>' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label2", true)) . '</span><span class="hidden_text">' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label2", true)) . '</span></span><span class="icon_holder" '.eltd_moose_get_inline_style($icon_span_border2).'><span>' . $second_button_icon_html . '</span><span class="hidden_icon">' . $second_button_icon_html . '</span></span></a>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-anchor-button", true) !== '') {
                        ...
                        if(get_post_meta(get_the_ID(), "eltd_slide-anchor-button_position", true) == 'in_content' || get_post_meta(get_the_ID(), "eltd_slide-anchor-button_position", true) == ''){
                            $slide_anchor_classes .= 'el slider_anchor_in_content';
                        }
                        elseif(get_post_meta(get_the_ID(), "eltd_slide-anchor-button_position", true) == 'bottom_of_slider'){
                            $slide_anchor_classes .= 'slider_anchor_on_bottom_of_the_slider';
                        }

                        $html_slider_anchor = '<div class="slide_anchor_holder '.esc_attr($slide_anchor_classes).'"><a ' . $slide_anchor_style . ' class="slide_anchor_button anchor" href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-anchor-button", true)) . '"><i class="icon-mouse"></i>Scroll down</a></div>';
                    }

                    if($html_slider_anchor != '' && (get_post_meta(get_the_ID(), "eltd_slide-anchor-button_position", true) == 'in_content' || get_post_meta(get_the_ID(), "eltd_slide-anchor-button_position", true) == '')){
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.eltd_moose_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.' '.$slide_data_content_resize.'>';
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.eltd_moose_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
                            ...
                            if($html_slider_anchor != '' && get_post_meta(get_the_ID(), "eltd_slide-anchor-button_position", true) == 'bottom_of_slider'){
                                $html .= $html_slider_anchor;
                            }
                        $html .= '</div>';
                    } else {
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.eltd_moose_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner" '.eltd_moose_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
								$html .= '</div>';
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    $triangle_bkg='';
                    if(isset($eltd_moose_options['enable_slider_triangle']) && $eltd_moose_options['enable_slider_triangle'] == 'yes') {
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if (isset($eltd_moose_options['navigation_arrows_type']) && $eltd_moose_options['navigation_arrows_type'] != '') {
                        $icon_navigation_class = $eltd_moose_options['navigation_arrows_type'];
                    }
            ...
            $html .= '</div>';
            if($eltd_moose_options['paspartu'] == 'yes' && $eltd_moose_options['paspartu_on_bottom_slider'] == 'yes') {
                $html .= '<div class="eltd_slider_bottom_paspartu"></div>';
            }
        }
