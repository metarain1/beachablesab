<?php
namespace ElatedCPT\Lib;

use ElatedCPT\CPT\Portfolio;
use ElatedCPT\CPT\Carousels;
use ElatedCPT\CPT\Slider;
use ElatedCPT\CPT\Testimonials;
use ElatedCPT\CPT\MasonryGallery;

/**
 * Class ShortcodeLoader
 * @package ElatedCPT\Lib
 */
class ShortcodeLoader {
    /**
