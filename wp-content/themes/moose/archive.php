...
?>
	...
	<script>
		...
		<?php if(isset($eltd_moose_options['blog_style']) && ($eltd_moose_options['blog_style'] == 4 || $eltd_moose_options['blog_style'] == 13 || $eltd_moose_options['blog_style'] == 15)){
			$blog_style_class = '';
			 if($eltd_moose_options['blog_style'] == 4){
				$blog_style_class = ' blog_masonry_full_width_template';
			}elseif($eltd_moose_options['blog_style'] == 15){
