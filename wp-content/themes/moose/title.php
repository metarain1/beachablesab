...
if(get_post_meta($id, "eltd_responsive-title-image", true) != ""){
 $responsive_title_image = get_post_meta($id, "eltd_responsive-title-image", true);
	...
	$responsive_title_image = $eltd_moose_options['responsive_title_image'];
}

if(get_post_meta($id, "eltd_fixed-title-image", true) != ""){
 $fixed_title_image = get_post_meta($id, "eltd_fixed-title-image", true);
}else{
	$fixed_title_image = $eltd_moose_options['fixed_title_image'];
}
...
if(get_post_meta($id, "eltd_title-image", true) != ""){
    ...
    $title_image = $eltd_moose_options['title_image'];
}
$title_image_height = "";
$title_image_width = "";
if($title_image !== ''){
	$title_image_dimensions_array = eltd_moose_get_image_dimensions($title_image);
...
elseif($eltd_moose_options['title_graphics'] != "") {
    $title_graphics = $eltd_moose_options['title_graphics'];
}
...
elseif (get_post_meta($id, 'page_page_title_whole_content_animations', true) == '' && isset($eltd_moose_options['page_title_whole_content_animations']) && $eltd_moose_options['page_title_whole_content_animations'] !== '') {
    $title_content_animation = $eltd_moose_options['page_title_whole_content_animations'];
}
...
if ($title_content_animation == 'yes') {
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_data_start', true) == '' && isset($eltd_moose_options['page_title_whole_content_data_start']) && $eltd_moose_options['page_title_whole_content_data_start'] !== '') {
        $page_title_content_data_start = $eltd_moose_options['page_title_whole_content_data_start'];
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_start_custom_style', true) == '' && isset($eltd_moose_options['page_title_whole_content_start_custom_style']) && $eltd_moose_options['page_title_whole_content_start_custom_style'] !== '') {
        $page_title_content_start_custom_style = $eltd_moose_options['page_title_whole_content_start_custom_style'];
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_data_end', true) == '' && isset($eltd_moose_options['page_title_whole_content_data_end']) && $eltd_moose_options['page_title_whole_content_data_end'] !== '') {
        $page_title_content_data_end = $eltd_moose_options['page_title_whole_content_data_end'];
    ...
    if (get_post_meta($id, 'page_page_title_whole_content_end_custom_style', true) == '' && isset($eltd_moose_options['page_title_whole_content_end_custom_style']) && $eltd_moose_options['page_title_whole_content_end_custom_style'] !== '') {
        $page_title_content_end_custom_style = $eltd_moose_options['page_title_whole_content_end_custom_style'];
...
elseif (get_post_meta($id, 'page_page_title_graphic_animations', true) == '' && isset($eltd_moose_options['page_title_graphic_animations']) && $eltd_moose_options['page_title_graphic_animations'] !== '') {
    $graphic_animation = $eltd_moose_options['page_title_graphic_animations'];
}
...
if ($title_graphics !== '' && $graphic_animation == 'yes'){
    ...
    if (get_post_meta($id, 'page_page_title_graphic_data_start', true) == '' && isset($eltd_moose_options['page_title_graphic_data_start']) && $eltd_moose_options['page_title_graphic_data_start'] !== '') {
        $page_title_graphic_data_start = $eltd_moose_options['page_title_graphic_data_start'];
    ...
    if(get_post_meta($id, 'page_page_title_graphic_start_custom_style', true) == '' && isset($eltd_moose_options['page_title_graphic_start_custom_style']) && $eltd_moose_options['page_title_graphic_start_custom_style'] !== '') {
        $page_title_graphic_start_custom_style = $eltd_moose_options['page_title_graphic_start_custom_style'];
    ...
    if(get_post_meta($id, 'page_page_title_graphic_data_end', true) == '' && isset($eltd_moose_options['page_title_graphic_data_end']) && $eltd_moose_options['page_title_graphic_data_end'] !== '') {
        $page_title_graphic_data_end = $eltd_moose_options['page_title_graphic_data_end'];
    ...
    if(get_post_meta($id, 'page_page_title_graphic_end_custom_style', true) == '' && isset($eltd_moose_options['page_title_graphic_end_custom_style']) && $eltd_moose_options['page_title_graphic_end_custom_style'] !== '') {
        $page_title_graphic_end_custom_style = $eltd_moose_options['page_title_graphic_end_custom_style'];
...
if(get_post_meta($id, "eltd_title-overlay-image", true) != ""){
 $title_overlay_image = get_post_meta($id, "eltd_title-overlay-image", true);
	...
	$title_overlay_image = $eltd_moose_options['title_overlay_image'];
}
...
if(isset($eltd_moose_options['enable_header_top_border']) && $eltd_moose_options['enable_header_top_border']=='yes' && isset($eltd_moose_options['header_top_border_width']) && $eltd_moose_options['header_top_border_width']!==''){
    $header_top_border = esc_attr($eltd_moose_options['header_top_border_width']);
}
if(isset($eltd_moose_options['enable_header_bottom_border']) && $eltd_moose_options['enable_header_bottom_border']=='yes' && isset($eltd_moose_options['header_bottom_border_width']) && $eltd_moose_options['header_bottom_border_width']!==''){
    $header_bottom_border = esc_attr($eltd_moose_options['header_bottom_border_width']);
}

$header_centered_logo_border = 0;
if(isset($eltd_moose_options['center_logo_image']) && $eltd_moose_options['center_logo_image'] == "yes" && isset($eltd_moose_options['enable_border_top_bottom_menu']) && $eltd_moose_options['enable_border_top_bottom_menu'] == "yes"){
    $header_centered_logo_border = 2;
}

$header_height = 110;
if (!empty($eltd_moose_options['header_height']) && $header_bottom_appearance != "fixed_hiding") {
    $header_height = esc_attr($eltd_moose_options['header_height']);
} elseif($header_bottom_appearance == "fixed_hiding"){
    $header_height = 110 + $logo_height/2 + 40; // 40 is top and bottom margin of logo
} elseif(isset($eltd_moose_options['center_logo_image']) && $eltd_moose_options['center_logo_image'] == "yes" && $header_bottom_appearance == "fixed") {
    if($header_bottom_appearance == "fixed" && $logo_height > 110){
        $header_height = 110 + 110 + 20; //20 is top and bottom margin of logo, 110 is default header height, other 110 is logo height
    }
    if($header_bottom_appearance == "fixed" && $logo_height < 110){
        $header_height = 110 + $logo_height + 20; //20 is top and bottom margin of logo, 110 is default header height
    }
}

if($eltd_moose_options['header_bottom_appearance'] == 'stick menu_bottom'){
    $menu_bottom = 60;
...
$header_top = 0;
if(isset($eltd_moose_options['header_top_area']) && $eltd_moose_options['header_top_area'] == "yes"){
	if(isset($eltd_moose_options['header_top_height']) && $eltd_moose_options['header_top_height'] !== ""){
		$header_top = $eltd_moose_options['header_top_height'];
	} else {
		$header_top = 36;
	}
}
...
}elseif(get_post_meta($id, "eltd_page_page_title_vertical_aligment", true) == '' && (isset($eltd_moose_options['page_title_vertical_aligment']) && $eltd_moose_options['page_title_vertical_aligment'] == 'header_bottom')) {
	$title_vertical_alignment = 'header_bottom';
} elseif(get_post_meta($id, "eltd_page_page_title_vertical_aligment", true) == '' && (isset($eltd_moose_options['page_title_vertical_aligment']) && $eltd_moose_options['page_title_vertical_aligment'] == 'window_top')) {
	$title_vertical_alignment = 'window_top';
}
...
if ($header_bottom_appearance != "fixed" && $header_bottom_appearance != "fixed_hiding" && $header_bottom_appearance != "regular") {
    if ($eltd_moose_options['center_logo_image'] != "yes") {
...
if (!empty($eltd_moose_options['header_height'])) {
    if($header_bottom_appearance == "fixed_hiding") {
        $header_height_padding =  esc_attr($eltd_moose_options['header_height']) + $header_top + $logo_height/2 + 40 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 40 is top and bottom margin of logo
    } elseif($eltd_moose_options['center_logo_image'] == "yes"){
        if($header_bottom_appearance == "fixed") {
            if ($eltd_moose_options['header_height'] > $logo_height) {
                $header_height_padding = esc_attr($eltd_moose_options['header_height']) + $header_top + $logo_height + 20 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 20 is top margin of logo
            } else {
                $header_height_padding = (esc_attr($eltd_moose_options['header_height'])) * 2 + $header_top + 20 + $header_top_border + $header_bottom_border + $header_centered_logo_border; // 20 is top margin of logo
            }
        }
        if($header_bottom_appearance == "stick"){
            $header_height_padding = (20 + $logo_height/2 + esc_attr($eltd_moose_options['header_height']) + $header_top + $header_top_border + $header_bottom_border + $header_centered_logo_border); // 20 is top margin of centered logo
        }
    } else {
        if($header_bottom_appearance != "stick menu_bottom") {
            $header_height_padding = esc_attr($eltd_moose_options['header_height']) + $header_top + $header_top_border + $header_bottom_border + $header_centered_logo_border;
        }
    }
}
...
if(get_post_meta($id, "eltd_page_title_type", true) != ""){
    ...
    if(isset($eltd_moose_options['title_type'])){
...
if(get_post_meta($id, "eltd_page_subtitle_position", true) != ""){
    ...
    if(isset($eltd_moose_options['subtitle_position'])){
        $subtitle_position = $eltd_moose_options['subtitle_position'];
    }
}
...
} elseif(get_post_meta($id, "eltd_show-page-title", true) == '' && (isset($eltd_moose_options['show_page_title']) && $eltd_moose_options['show_page_title'] == 'yes')) {
	$is_title_area_visible = true;
} elseif(get_post_meta($id, "eltd_show-page-title", true) == '' && (isset($eltd_moose_options['show_page_title']) && $eltd_moose_options['show_page_title'] == 'no')) {
	$is_title_area_visible = false;
} elseif(isset($eltd_moose_options['show_page_title']) && $eltd_moose_options['show_page_title'] == 'yes') {
	$is_title_area_visible = true;
}
...
elseif (get_post_meta($id, 'page_page_title_animations', true) == '' && isset($eltd_moose_options['page_title_animations']) && $eltd_moose_options['page_title_animations'] !== '') {
    $title_animation = $eltd_moose_options['page_title_animations'];
}
...
if($is_title_text_visible && $title_animation == 'yes') {
    ...
    if(get_post_meta($id, 'page_page_title_data_start', true) == '' && isset($eltd_moose_options['page_title_data_start']) && $eltd_moose_options['page_title_data_start'] !== '') {
        $page_title_data_start = $eltd_moose_options['page_title_data_start'];
    ...
    if(get_post_meta($id, 'page_page_title_start_custom_style', true) == '' && isset($eltd_moose_options['page_title_start_custom_style']) && $eltd_moose_options['page_title_start_custom_style'] !== '') {
        $page_title_start_custom_style = $eltd_moose_options['page_title_start_custom_style'];
    ...
    if(get_post_meta($id, 'page_page_title_data_end', true) == '' && isset($eltd_moose_options['page_title_data_end']) && $eltd_moose_options['page_title_data_end'] !== '') {
        $page_title_data_end = $eltd_moose_options['page_title_data_end'];
    } elseif(get_post_meta($id, 'page_page_title_data_end', true) !== '') {
        $page_title_data_end = get_post_meta($id, 'page_page_title_data_end', true);
    }

    if(get_post_meta($id, 'page_page_title_end_custom_style', true) == '' && isset($eltd_moose_options['page_title_end_custom_style']) && $eltd_moose_options['page_title_end_custom_style'] !== '') {
        $page_title_end_custom_style = $eltd_moose_options['page_title_end_custom_style'];
...
if(get_post_meta($id, "eltd_header_color_transparency_per_page", true) === "" || eltd_moose_is_default_wp_template()) {
...
if(isset($eltd_moose_options['header_bottom_appearance']) && ($eltd_moose_options['header_bottom_appearance'] == "stick" || $eltd_moose_options['header_bottom_appearance'] == "stick menu_bottom" || $eltd_moose_options['header_bottom_appearance'] == "stick_with_left_right_menu")){
...
}elseif($eltd_moose_options['title_height'] != ''){
	$title_height = esc_attr($eltd_moose_options['title_height']);
}
//is header solid?
if(!$is_header_solid && !$is_header_initially_hidden && $eltd_moose_options['header_bottom_appearance'] != 'regular' && get_post_meta($id, "eltd_enable_content_top_margin", true) != "yes"){
//	if ((isset($eltd_moose_options['center_logo_image']) && $eltd_moose_options['center_logo_image'] == "yes") || $eltd_moose_options['header_bottom_appearance'] == 'fixed_hiding') {
//		if($eltd_moose_options['header_bottom_appearance'] == 'stick menu_bottom'){
//	        $title_height = $title_height + $header_height + $header_top + $logo_height + 20; // 20 is top margin of centered logo
//	    } elseif($eltd_moose_options['header_bottom_appearance'] == 'fixed_hiding' || $eltd_moose_options['header_bottom_appearance'] == 'fixed'){
//	        if(!empty($eltd_moose_options['header_height']) && $eltd_moose_options['header_bottom_appearance'] == "fixed"){
//	        	$title_height = $title_height + $eltd_moose_options['header_height'] + $header_top + $logo_height + 20;
//	        } else {
...
if(get_post_meta($id, "eltd_page-title-background-color", true) != ""){
    ...
    $title_background_color = esc_attr($eltd_moose_options['title_background_color']);
}
...
if(get_post_meta($id, "eltd_page_title_style", true) != ""){
    ...
    if(isset($eltd_moose_options['title_style'])) {
        $eltd_page_title_style = $eltd_moose_options['title_style'];
    } else {
        $eltd_page_title_style = "standard";
    }
}
...
if(get_post_meta($id, "eltd_animate_page_title", true) != ""){
    ...
    $animate_title_area = $eltd_moose_options['animate_title_area'];
}
...
if(eltd_moose_is_side_header() && isset($eltd_moose_options['paspartu']) && $eltd_moose_options['paspartu'] == 'no'){
    ...
    if(get_post_meta($id, "eltd_title-height", true) != ""){
        ...
        $title_height = esc_attr(get_post_meta($id, "eltd_title-height", true));
    }else if($eltd_moose_options['title_height'] != ''){
        $title_holder_height = $eltd_moose_options['title_height'];
        $title_height = esc_attr($eltd_moose_options['title_height']);
    }
...
}elseif(isset($eltd_moose_options['enable_breadcrumbs'])){
	$enable_breadcrumbs = $eltd_moose_options['enable_breadcrumbs'];
}
...
elseif (get_post_meta($id, 'page_page_title_breadcrumbs_animations', true) == '' && isset($eltd_moose_options['page_title_breadcrumbs_animations']) && $eltd_moose_options['page_title_breadcrumbs_animations'] !== '') {
    $breadcrumbs_animation = $eltd_moose_options['page_title_breadcrumbs_animations'];
}
...
if($enable_breadcrumbs == 'yes' && $breadcrumbs_animation == 'yes') {
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_data_start', true) == '' && isset($eltd_moose_options['page_title_breadcrumbs_data_start']) && ($eltd_moose_options['page_title_breadcrumbs_data_start'] !== '')) {
        $page_title_breadcrumbs_data_start = $eltd_moose_options['page_title_breadcrumbs_data_start'];
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_start_custom_style', true) == '' && isset($eltd_moose_options['page_title_breadcrumbs_start_custom_style']) && ($eltd_moose_options['page_title_breadcrumbs_start_custom_style'] !== '')) {
        $page_title_breadcrumbs_start_custom_style = $eltd_moose_options['page_title_breadcrumbs_start_custom_style'];
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_data_end', true) == '' && isset($eltd_moose_options['page_title_breadcrumbs_data_end']) && ($eltd_moose_options['page_title_breadcrumbs_data_end'] !== '')) {
        $page_title_breadcrumbs_data_end = $eltd_moose_options['page_title_breadcrumbs_data_end'];
    ...
    if(get_post_meta($id, 'page_page_title_breadcrumbs_end_custom_style', true) == '' && isset($eltd_moose_options['page_title_breadcrumbs_end_custom_style']) && ($eltd_moose_options['page_title_breadcrumbs_end_custom_style'] !== '')) {
        $page_title_breadcrumbs_end_custom_style = $eltd_moose_options['page_title_breadcrumbs_end_custom_style'];
...
if(get_post_meta($id, "eltd_title_text_shadow", true) != ""){
	...
	if($eltd_moose_options['title_text_shadow'] == "yes"){
		$title_text_shadow = ' title_text_shadow';
	}
}
$subtitle_color ="";
...
$subtitle_size_class = '';
if (get_post_meta($id, 'eltd_page_subtitle_text_size', true) !== '') {
    $subtitle_size_class = get_post_meta($id, 'eltd_page_subtitle_text_size', true);
} else if (isset($eltd_moose_options['subtitle_text_size']) && $eltd_moose_options['subtitle_text_size'] !== "" ) {
	$subtitle_size_class = $eltd_moose_options['subtitle_text_size'];
}
...
if (is_tag()) {
	...
	if($eltd_moose_options['404_title'] != "") {
		$title = $eltd_moose_options['404_title'];
	} else { 
		$title = __('Oops, this page can not be found', 'eltd');
	}
...
if (get_post_meta($id,"eltd_title_like_separator",true) == "yes" || (isset($eltd_moose_options['title_like_separator']) && $eltd_moose_options['title_like_separator']=='yes' && get_post_meta($id,"eltd_title_like_separator",true) != "no")) {
...
if ($title_like_separator) {
    ...
    elseif (isset($eltd_moose_options['page_title_position']) && !empty($eltd_moose_options['page_title_position'])) {
        $title_shortcode .= ' text_position = "' . $eltd_moose_options['page_title_position'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['title_like_separator_line_color']) && !empty($eltd_moose_options['title_like_separator_line_color'])) {
        $title_shortcode .= ' line_color = "' . $eltd_moose_options['title_like_separator_line_color'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['title_like_separator_line_width']) && !empty($eltd_moose_options['title_like_separator_line_width'])) {
        $title_shortcode .= ' line_width = "' . $eltd_moose_options['title_like_separator_line_width'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['title_like_separator_line_thickness']) && !empty($eltd_moose_options['title_like_separator_line_thickness'])) {
        $title_shortcode .= ' line_thickness = "' . $eltd_moose_options['title_like_separator_line_thickness'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['title_like_separator_line_style']) && !empty($eltd_moose_options['title_like_separator_line_style'])) {
        $title_shortcode .= ' line_border_style = "' . $eltd_moose_options['title_like_separator_line_style'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['title_like_separator_margins']) && !empty($eltd_moose_options['title_like_separator_margins'])) {
        $title_shortcode .= ' box_margin = "' . $eltd_moose_options['title_like_separator_margins'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['title_like_separator_line_dots']) && !empty($eltd_moose_options['title_like_separator_line_dots'])) {
        $title_shortcode .= ' line_dots = "' . $eltd_moose_options['title_like_separator_line_dots'] . '"';
        if ($eltd_moose_options['title_like_separator_line_dots'] == "yes") {
            $title_like_separator_dots = true;
        }
    }
    ...
    if ($title_like_separator_dots) {          
        ...
        elseif (isset($eltd_moose_options['title_like_separator_dots_size']) && !empty($eltd_moose_options['title_like_separator_dots_size'])) {
            $title_shortcode .= ' line_dots_size = "' . $eltd_moose_options['title_like_separator_dots_size'] . '"';
        }
        ...
        elseif (isset($eltd_moose_options['title_like_separator_dots_color']) && !empty($eltd_moose_options['title_like_separator_dots_color'])) {
            $title_shortcode .= ' line_dots_color = "' . $eltd_moose_options['title_like_separator_dots_color'] . '"';
        }
    }
    ...
    if (get_post_meta($id,'eltd_title_background_color',true) != "") {
        $title_span_background_color_rgb = eltd_moose_hex2rgb(esc_attr(get_post_meta($id, 'eltd_title_background_color', true)));
    }
...
if (get_post_meta($id,"eltd_subtitle_like_separator",true) == "yes" || (isset($eltd_moose_options['subtitle_like_separator']) && $eltd_moose_options['subtitle_like_separator']=='yes' && get_post_meta($id,"eltd_subtitle_like_separator",true) != "no")) {
...
if ($subtitle_like_separator) {
    ...
    elseif (isset($eltd_moose_options['page_title_position']) && !empty($eltd_moose_options['page_title_position'])) {
        $subtitle_shortcode .= ' text_position = "' . $eltd_moose_options['page_title_position'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['subtitle_like_separator_line_color']) && !empty($eltd_moose_options['subtitle_like_separator_line_color'])) {
        $subtitle_shortcode .= ' line_color = "' . $eltd_moose_options['subtitle_like_separator_line_color'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['subtitle_like_separator_line_width']) && !empty($eltd_moose_options['subtitle_like_separator_line_width'])) {
        $subtitle_shortcode .= ' line_width = "' . $eltd_moose_options['subtitle_like_separator_line_width'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['subtitle_like_separator_line_thickness']) && !empty($eltd_moose_options['subtitle_like_separator_line_thickness'])) {
        $subtitle_shortcode .= ' line_thickness = "' . $eltd_moose_options['subtitle_like_separator_line_thickness'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['subtitle_like_separator_line_style']) && !empty($eltd_moose_options['subtitle_like_separator_line_style'])) {
        $subtitle_shortcode .= ' line_border_style = "' . $eltd_moose_options['subtitle_like_separator_line_style'] . '"';
    }
    ...
    elseif (isset($eltd_moose_options['subtitle_like_separator_margins']) && !empty($eltd_moose_options['subtitle_like_separator_margins'])) {
        $subtitle_shortcode .= ' box_margin = "' . $eltd_moose_options['subtitle_like_separator_margins'] . '" ';
    }
    ...
    if (get_post_meta($id,'eltd_subtitle_background_color',true) != "") {
        $subtitle_span_background_color_rgb = eltd_moose_hex2rgb(esc_attr(get_post_meta($id, 'eltd_subtitle_background_color', true)));
    }
...
$separator_animation = '';
if (get_post_meta($id,'eltd_title_separator',true) == "yes"  || (!empty($eltd_moose_options['title_separator']) && $eltd_moose_options['title_separator']=='yes' && get_post_meta($id,'eltd_title_separator',true) != "no")) {
    $title_separator = "yes";
    ...
    elseif (isset($eltd_moose_options['title_separator_position']) && $eltd_moose_options['title_separator_position'] == "above") {
        $title_separator_position_vertical = "above";
    }
    ...
    elseif ($eltd_moose_options['title_separator_format'] == "with_icon" || $eltd_moose_options['title_separator_format'] == "with_custom_icon") {
        $with_icon = true;
    }
    ...
    if ($with_icon) {
        ...
        if (get_post_meta($id,'eltd_title_separator_format',true) != "") {
            ...
            $separator_shortcode_params .= ' type = "' . $eltd_moose_options['title_separator_format'] . '" ';
        }

        if (get_post_meta($id,'eltd_title_separator_format',true) == "with_custom_icon" || (get_post_meta($id,'eltd_title_separator_format',true) == "" && $eltd_moose_options['title_separator_format'] == "with_custom_icon")) {
            ...
            elseif (isset($eltd_moose_options['separator_custom_icon']) && !empty($eltd_moose_options['separator_custom_icon'])) {
                $separator_shortcode_params .= ' custom_icon ="' . $eltd_moose_options['separator_custom_icon'] . '" ';
            }
        }
        else {
            ...
            elseif (isset($eltd_moose_options['separator_icon_pack']) && !empty($eltd_moose_options['separator_icon_pack'])) {

                $separator_shortcode_params .= $eltdIconCollections->iconPackParamName.'="'.$eltd_moose_options['separator_icon_pack'].'"';

                $icon_collection = $eltdIconCollections->getIconCollection($eltd_moose_options['separator_icon_pack']);

                if(is_object($icon_collection) && isset($eltd_moose_options['separator_icon_'.$icon_collection->param]) && !empty($eltd_moose_options['separator_icon_'.$icon_collection->param])) {
                    $separator_shortcode_params .= ' '.$icon_collection->param.'="'.$eltd_moose_options['separator_icon_'.$icon_collection->param].'"';
                }
            }
            ...
            elseif (isset($eltd_moose_options['title_separator_icon_hover_color']) && !empty($eltd_moose_options['title_separator_icon_hover_color'])) {
                $separator_shortcode_params .= ' hover_icon_color = "'.$eltd_moose_options['title_separator_icon_hover_color'].'"';
            }
            ...
            elseif (isset($eltd_moose_options['title_separator_icon_color']) && !empty($eltd_moose_options['title_separator_icon_color'])) {
                $separator_shortcode_params .= ' icon_color = "'.$eltd_moose_options['title_separator_icon_color'].'"';
            }
            ...
            elseif (isset($eltd_moose_options['title_separator_icon_custom_size']) && !empty($eltd_moose_options['title_separator_icon_custom_size'])) {
                $separator_shortcode_params .= ' icon_custom_size = "'.$eltd_moose_options['title_separator_icon_custom_size'].'"';
            }
            ...
            elseif (isset($eltd_moose_options['title_separator_icon_type']) && !empty($eltd_moose_options['title_separator_icon_type'])) {
                $separator_shortcode_params .= ' icon_type = "'.$eltd_moose_options['title_separator_icon_type'].'"';
                $separator_type = $eltd_moose_options['title_separator_icon_type'];
            }
            ...
            if ($separator_type != "normal"){
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_border_radius']) && !empty($eltd_moose_options['title_separator_icon_border_radius'])) {
                    $separator_shortcode_params .= ' icon_border_radius = "'.$eltd_moose_options['title_separator_icon_border_radius'].'"';
                }
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_border_width']) && !empty($eltd_moose_options['title_separator_icon_border_width'])) {
                    $separator_shortcode_params .= ' icon_border_width = "'.$eltd_moose_options['title_separator_icon_border_width'].'"';
                }
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_border_color']) && !empty($eltd_moose_options['title_separator_icon_border_color'])) {
                    $separator_shortcode_params .= ' icon_border_color = "'.$eltd_moose_options['title_separator_icon_border_color'].'"';
                }
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_border_hover_color']) && !empty($eltd_moose_options['title_separator_icon_border_hover_color'])) {
                    $separator_shortcode_params .= ' hover_icon_border_color = "'.$eltd_moose_options['title_separator_icon_border_hover_color'].'"';
                }
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_shape_size']) && !empty($eltd_moose_options['title_separator_icon_shape_size'])) {
                    $separator_shortcode_params .= ' icon_shape_size = "'.$eltd_moose_options['title_separator_icon_shape_size'].'"';
                }
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_background_color']) && !empty($eltd_moose_options['title_separator_icon_background_color'])) {
                    $separator_shortcode_params .= ' icon_background_color = "'.$eltd_moose_options['title_separator_icon_background_color'].'"';
                }
                ...
                elseif (isset($eltd_moose_options['title_separator_icon_background_hover_color']) && !empty($eltd_moose_options['title_separator_icon_background_hover_color'])) {
                    $separator_shortcode_params .= ' hover_icon_background_color = "'.$eltd_moose_options['title_separator_icon_background_hover_color'].'"';
                }
            }
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_color']) && !empty($eltd_moose_options['title_separator_color'])) {
            $separator_shortcode_params .= ' color = "'.$eltd_moose_options['title_separator_color'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_type']) && !empty($eltd_moose_options['title_separator_type'])) {
            $separator_shortcode_params .= ' border_style = "'.$eltd_moose_options['title_separator_type'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_thickness']) && !empty($eltd_moose_options['title_separator_thickness'])) {
            $separator_shortcode_params .= ' thickness = "'.$eltd_moose_options['title_separator_thickness'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_width']) && !empty($eltd_moose_options['title_separator_width'])) {
            $separator_shortcode_params .= ' width = "'.$eltd_moose_options['title_separator_width'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_topmargin']) && !empty($eltd_moose_options['title_separator_topmargin'])) {
            $separator_shortcode_params .= ' up = "'.$eltd_moose_options['title_separator_topmargin'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_bottommargin']) && !empty($eltd_moose_options['title_separator_bottommargin'])) {
            $separator_shortcode_params .= ' down = "'.$eltd_moose_options['title_separator_bottommargin'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_icon_position']) && !empty($eltd_moose_options['title_separator_icon_position'])) {
            $separator_shortcode_params .= ' separator_icon_position = "'.$eltd_moose_options['title_separator_icon_position'].'"';
        }
        ...
        elseif (isset($eltd_moose_options['title_separator_icon_margins']) && !empty($eltd_moose_options['title_separator_icon_margins'])) {
            $separator_shortcode_params .= ' icon_margin = "'.$eltd_moose_options['title_separator_icon_margins'].'"';
        }
    }
		...
		elseif(isset($eltd_moose_options['page_title_position']) && !empty($eltd_moose_options['page_title_position'])) {
			$separator_title_position = $eltd_moose_options['page_title_position'];
		}
		...
		elseif(!empty($eltd_moose_options['title_separator_color'])){
			$title_separator_style .= 'border-color:'.esc_attr($eltd_moose_options['title_separator_color']).';';
		}
		...
		elseif(isset($eltd_moose_options['title_separator_thickness']) && !empty($eltd_moose_options['title_separator_thickness'])) {
			$title_separator_style .= 'border-width: ' . esc_attr($eltd_moose_options['title_separator_thickness']) . 'px 0 0;';
		}
		...
		elseif(isset($eltd_moose_options['title_separator_width']) && !empty($eltd_moose_options['title_separator_width'])) {
			$title_separator_style .= 'width: ' . esc_attr($eltd_moose_options['title_separator_width']) . 'px;';
		}
		...
		elseif(isset($eltd_moose_options['title_separator_topmargin']) && !empty($eltd_moose_options['title_separator_topmargin'])) {
			$title_separator_style .= 'margin-top: ' . esc_attr($eltd_moose_options['title_separator_topmargin']) . 'px;';
		}
		...
		elseif(isset($eltd_moose_options['title_separator_bottommargin']) && !empty($eltd_moose_options['title_separator_bottommargin'])) {
			$title_separator_style .= 'margin-bottom: ' . esc_attr($eltd_moose_options['title_separator_bottommargin']) . 'px;';
		}
		...
		elseif(isset($eltd_moose_options['title_separator_type']) && !empty($eltd_moose_options['title_separator_type'])) {
			$title_separator_style .= 'border-style: ' . esc_attr($eltd_moose_options['title_separator_type']) . ';';
		}
    }
    ...
    elseif($eltd_moose_options['page_title_separator_animations'] && $eltd_moose_options['page_title_separator_animations'] !== '') {
        $separator_animation = $eltd_moose_options['page_title_separator_animations'];
    }
    ...
    if($separator_animation == 'yes') {
        ...
        if(get_post_meta($id, 'page_page_title_separator_data_start', true) == '' && isset($eltd_moose_options['page_title_separator_data_start']) && $eltd_moose_options['page_title_separator_data_start'] !== '') {
            $page_title_separator_data_start = $eltd_moose_options['page_title_separator_data_start'];
        ...
        if(get_post_meta($id, 'page_page_title_separator_start_custom_style', true) == '' && isset($eltd_moose_options['page_title_separator_start_custom_style']) && $eltd_moose_options['page_title_separator_start_custom_style'] !== '') {
            $page_title_separator_start_custom_style = $eltd_moose_options['page_title_separator_start_custom_style'];
        ...
        if(get_post_meta($id, 'page_page_title_separator_data_end', true) == '' && isset($eltd_moose_options['page_title_separator_data_end']) && $eltd_moose_options['page_title_separator_data_end'] !== '') {
            $page_title_separator_data_end = $eltd_moose_options['page_title_separator_data_end'];
        ...
        if(get_post_meta($id, 'page_page_title_separator_end_custom_style', true) == '' && isset($eltd_moose_options['page_title_separator_end_custom_style']) && $eltd_moose_options['page_title_separator_end_custom_style'] !== '') {
            $page_title_separator_end_custom_style = $eltd_moose_options['page_title_separator_end_custom_style'];
...
if (get_post_meta($id,'eltd_title_area_content_background_color',true) != "") {
    $title_area_content_background_color_rgb = eltd_moose_hex2rgb(esc_attr(get_post_meta($id, 'eltd_title_area_content_background_color', true)));
}
...
if (get_post_meta($id,'eltd_title_content_top_padding',true) != "") {
	$title_area_content_padding .= 'padding-top: ' . esc_attr(get_post_meta($id,'eltd_title_content_top_padding',true)). 'px; ';
}
if (get_post_meta($id,'eltd_title_content_right_padding',true) != "") {
	$title_area_content_padding .= 'padding-right: ' . esc_attr(get_post_meta($id,'eltd_title_content_right_padding',true)). 'px; ';
}
if (get_post_meta($id,'eltd_title_content_bottom_padding',true) != "") {
	$title_area_content_padding .= 'padding-bottom: ' . esc_attr(get_post_meta($id,'eltd_title_content_bottom_padding',true)). 'px; ';
}
if (get_post_meta($id,'eltd_title_content_left_padding',true) != "") {
	$title_area_content_padding .= 'padding-left: ' . esc_attr(get_post_meta($id,'eltd_title_content_left_padding',true)). 'px; ';
}
...
if (get_post_meta($id, 'eltd_page_subtitle', true) !== '') {
    ...
    elseif (isset($eltd_moose_options['page_subtitle_animations']) && $eltd_moose_options['page_subtitle_animations'] !== '') {
        $subtitle_animation = $eltd_moose_options['page_subtitle_animations'];
    }
    ...
    if ($subtitle_animation == 'yes') {
        ...
        if(get_post_meta($id, 'page_page_subtitle_data_start', true) == '' && isset($eltd_moose_options['page_subtitle_data_start']) && ($eltd_moose_options['page_subtitle_data_start'] !== '')) {
            $page_subtitle_data_start = $eltd_moose_options['page_subtitle_data_start'];
        ...
        if(get_post_meta($id, 'page_page_subtitle_start_custom_style', true) == '' && isset($eltd_moose_options['page_subtitle_start_custom_style']) && ($eltd_moose_options['page_subtitle_start_custom_style'] !== '')) {
            $page_subtitle_start_custom_style = $eltd_moose_options['page_subtitle_start_custom_style'];
        ...
        if(get_post_meta($id, 'page_page_subtitle_data_end', true) == '' && isset($eltd_moose_options['page_subtitle_data_end']) && ($eltd_moose_options['page_subtitle_data_end'] !== '')) {
            $page_subtitle_data_end = $eltd_moose_options['page_subtitle_data_end'];
        ...
        if(get_post_meta($id, 'page_page_subtitle_end_custom_style', true) == '' && isset($eltd_moose_options['page_subtitle_end_custom_style']) && ($eltd_moose_options['page_subtitle_end_custom_style'] !== '')) {
            $page_subtitle_end_custom_style = $eltd_moose_options['page_subtitle_end_custom_style'];
...
$title_border_top_style = '';
$title_border_bottom_style = '';
if ( get_post_meta($id,'eltd_border_top_title_area',true) == "yes" ) {
	if (get_post_meta($id,'eltd_border_top_title_area_color',true) !== '') {
		$title_border_top_style .= 'border-top-color: '.get_post_meta($id,'eltd_border_top_title_area_color',true).';';
	}
	if (get_post_meta($id,'eltd_border_top_title_area_width',true) !== '') {
		$title_border_top_style .= 'border-top-width: '.get_post_meta($id,'eltd_border_top_title_area_width',true).'px;';
	}
	$title_border_top_style .= 'border-top-style: solid;';
} else if ( get_post_meta($id,'eltd_border_top_title_area',true) == "no" ) {
	$title_border_top_style .= 'border-top-width: 0;';
}

if ( get_post_meta($id,'eltd_border_bottom_title_area',true) == "yes" ) {
	if (get_post_meta($id,'eltd_border_bottom_title_area_color',true) !== '') {
		$title_border_bottom_style .= 'border-bottom-color: '.get_post_meta($id,'eltd_border_bottom_title_area_color',true).';';
	}
	if (get_post_meta($id,'eltd_border_bottom_title_area_width',true) !== '') {
		$title_border_bottom_style .= 'border-bottom-width: '.get_post_meta($id,'eltd_border_bottom_title_area_width',true).'px;';
	}
	$title_border_bottom_style .= 'border-bottom-style: solid;';
} else if ( get_post_meta($id,'eltd_border_bottom_title_area',true) == "no" ) {
	$title_border_bottom_style .= 'border-bottom-width: 0;';
}

if (get_post_meta($id,'eltd_enable_title_border_top_grid',true) == "yes") {
	$title_container_style .= $title_border_top_style;
	if ($eltd_moose_options['enable_title_border_grid'] == 'no') {
		$title_bckg_style .= 'border-top-width: 0;';
	}
} else if (get_post_meta($id,'eltd_enable_title_border_top_grid',true) == "no") {
	if ($eltd_moose_options['enable_title_border_grid'] == 'yes') {
		$title_container_style .= 'border-top-width: 0;';
	}
	$title_bckg_style .= $title_border_top_style;
}
if (get_post_meta($id,'eltd_enable_title_border_bottom_grid',true) == "yes") {
	$title_container_style .= $title_border_bottom_style;
	if ($eltd_moose_options['enable_title_border_grid'] == 'no') {
		$title_bckg_style .= 'border-bottom-width: 0;';
	}
} else if (get_post_meta($id,'eltd_enable_title_border_bottom_grid',true) == "no") {
	if ($eltd_moose_options['enable_title_border_grid'] == 'yes') {
		$title_container_style .= 'border-bottom-width: 0;';
	}
	$title_bckg_style .= $title_border_bottom_style;
}
...
if($is_title_area_visible) { ?>
	<div class="title_outer <?php echo esc_attr($animate_title_class.$title_text_shadow); if($responsive_title_image == 'yes' && $show_title_image == true && $title_image !== ''){ echo ' with_image'; }?>" <?php echo esc_attr($animation); ?> <?php echo 'data-height="'.esc_attr($title_height).'"'; if($title_height != '' && $animate_title_area == 'area_top_bottom'){ echo ' style="opacity:0; height:0px;"'; } ?>>
		<div class="title <?php eltd_moose_title_classes(); ?>" style="<?php if($responsive_title_image == 'no' && $title_image != "" && $show_title_image == true){ if($title_image_width != ''){ echo 'background-size:'.esc_attr($title_image_width).'px auto;'; } echo 'background-image:url('.esc_url($title_image).');';  } if($title_height != ''){ echo 'height:'.esc_attr($title_height).'px;'; } if($title_background_color != ''){ echo 'background-color:'.esc_attr($title_background_color).';'; } echo esc_attr($title_bckg_style); ?>">
			...
			<div class="title_holder" <?php print $page_title_content_animation_data; ?> <?php if($responsive_title_image != 'yes'){ eltd_moose_inline_style($title_holder_height); } ?>>
				<div class="container clearfix">
					<div class="container_inner clearfix" <?php echo eltd_moose_get_inline_style($title_container_style);?> >
						<div class="title_subtitle_holder <?php echo esc_attr($title_content_classes); ?>" <?php if($title_image !== '' && $responsive_title_image == 'yes' && $show_title_image == true){ eltd_moose_inline_style($title_subtitle_padding); } if($title_content_classes !== ""){ eltd_moose_inline_style($title_area_style); } ?>>
                            <?php if($eltd_moose_options['overlapping_content'] == 'yes') {?><div class="overlapping_content_margin"><?php } ?>
							...
							<div class="title_subtitle_holder_inner title_content_background" <?php eltd_moose_inline_style($title_area_style); ?>>
							<?php } ?>
								<?php if($title_type != "breadcrumbs_title") { ?>
									...
									<?php if($subtitle_position=="above_title"){?>
										<?php if(get_post_meta($id, "eltd_page_subtitle", true) != ""){ 
												if ($subtitle_like_separator){?>
												<span class="subtitle subtitle_like_separator <?php echo esc_attr($subtitle_in_box); ?> <?php echo esc_attr($subtitle_size_class); ?>" <?php eltd_moose_inline_style($subtitle_color); ?>><span class="span_subtitle_separator" <?php print $page_subtitle_animation_data; ?> > <?php echo do_shortcode($subtitle_shortcode); // XSS OK ?></span></span>
												<?php }
												else {
											?>
												<span class="subtitle <?php echo esc_attr($subtitle_size_class); ?>" <?php eltd_moose_inline_style($subtitle_color); ?>><span <?php print $page_subtitle_animation_data; ?> <?php eltd_moose_inline_style($subtitle_span_style); ?>><?php echo wp_kses_post(get_post_meta($id, "eltd_page_subtitle", true)); ?></span></span>
										<?php }
										} ?>
									<?php } ?>
                                    ...
                                    <?php if($title_separator == "yes" && $title_separator_position_vertical == "above"){
                                            ...
                                            <?php }
                                                ...
                                                <span class="separator small <?php echo esc_attr($separator_title_position); ?>" <?php eltd_moose_inline_style($title_separator_style); ?>  <?php print $page_title_separator_animation_data; ?>></span>
                                            <?php } ?>
                                    <?php } ?>
                                    ...
                                    <?php if($is_title_text_visible) {
                                            if ($subtitle_position == "next_to_title" && get_post_meta($id, "eltd_page_subtitle", true) != ""){?>
                                                <h1<?php print $page_title_animation_data; if(get_post_meta($id, "eltd_page-title-color", true)) { ?> style="color:<?php echo esc_attr(get_post_meta($id, "eltd_page-title-color", true)); ?>" <?php } ?>><span <?php eltd_moose_inline_style($title_span_style); ?>><?php echo wp_kses_post($title); ?></span></h1>
                                                <span class="subtitle next_to_title <?php echo esc_attr($subtitle_size_class); ?>" <?php eltd_moose_inline_style($subtitle_color); ?>><span <?php print $page_subtitle_animation_data; ?> <?php eltd_moose_inline_style($subtitle_span_style); ?>><?php echo wp_kses_post(get_post_meta($id, "eltd_page_subtitle", true)); ?></span></span>
                                        <?php }
                                            else{
                                                if($title_like_separator){ ?>
								...
								<?php } ?>
									...
									<?php if (function_exists('eltd_moose_custom_breadcrumbs') && $enable_breadcrumbs == "yes") { ?>
										<div class="breadcrumb" <?php print $page_title_breadcrumbs_animation_data; ?>> <?php eltd_moose_custom_breadcrumbs(); ?></div>
									<?php } ?>
							...
							<?php } ?>
                                <?php if($eltd_moose_options['overlapping_content'] == 'yes') {?></div><?php } ?>
						</div>
					</div>
				</div>
			</div>
