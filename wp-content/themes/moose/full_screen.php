...
if(get_post_meta($id, "eltd_page_background_color", true) != ""){
    $full_screen_holder_style .= "background-color:".esc_attr(get_post_meta($id, "eltd_page_background_color", true)).";";
}else{
    $full_screen_holder_style .= "";
}
...
$fs_navigation_type = "";
if(isset($eltd_moose_options['fs_navigation_slider_vertical_section_type'])){
    $fs_navigation_type = $eltd_moose_options['fs_navigation_slider_vertical_section_type'];
}
    ...
    <div class="full_screen_preloader">
        ...
        if($eltd_moose_options['loading_animation'] == "on") {
            if($eltd_moose_options['loading_image'] != "") { ?>
                <div class="ajax_loader"><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="<?php echo esc_url($eltd_moose_options['loading_image']) ?>" alt="" /></div></div></div>
            <?php }
            else { ?>
                <div class="ajax_loader"><div class="ajax_loader_1"><?php eltd_moose_loading_spinners(); ?></div></div>
            <?php }
        }
        ?>
    </div>

    <div class="full_screen_holder"<?php eltd_moose_inline_style($full_screen_holder_style); ?>>
        <div class="full_screen_inner" <?php eltd_moose_inline_style($content_style); ?>>
