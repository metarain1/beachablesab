...
if(isset($eltd_moose_options['blog_split_column_content_position'])){
	$blog_content_position = $eltd_moose_options['blog_split_column_content_position'];
}
...
if(isset($eltd_moose_options['blog_split_column_number_of_chars']) && $eltd_moose_options['blog_split_column_number_of_chars'] != "") {
	eltd_moose_set_blog_word_count(esc_attr($eltd_moose_options['blog_split_column_number_of_chars']));
}
