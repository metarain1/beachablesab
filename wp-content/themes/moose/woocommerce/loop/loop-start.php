...
if(isset($eltd_moose_options['woo_products_hover_list_type'])){
    $products_hover_list_type = $eltd_moose_options['woo_products_hover_list_type'];
}
$class='';
...
$disable_space = '';
if(isset($eltd_moose_options['woo_products_disable_space_between_products']) && $eltd_moose_options['woo_products_disable_space_between_products']=='yes'){
