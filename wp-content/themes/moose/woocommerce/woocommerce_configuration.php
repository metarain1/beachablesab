...
if(!function_exists('eltd_woo_related_products_args')) {
    ...
    function eltd_woo_related_products_args( $args ) {
        ...
        if(isset($eltd_moose_options['woo_products_list_number']) && $eltd_moose_options['woo_products_list_number'] != ''){
            switch($eltd_moose_options['woo_products_list_number']){
                case('columns-3') :
...
if(!function_exists('eltd_woo_product_per_page')) {
    ...
    function eltd_woo_product_per_page() {
        ...
        if(isset($eltd_moose_options['woo_products_per_page']) && $eltd_moose_options['woo_products_per_page']) {
            $products_per_page = $eltd_moose_options['woo_products_per_page'];
        }
...
if(!function_exists('eltd_woocommerce_content_berfore')) {
	function eltd_woocommerce_content_before() {
...
if(!function_exists('eltd_woocommerce_share')) {
    function eltd_woocommerce_share() {
        ...
        if (isset($eltd_moose_options['enable_social_share'])&& ($eltd_moose_options['enable_social_share']) =="yes"){
            if (isset($eltd_moose_options['post_types_names_product'])&& $eltd_moose_options['post_types_names_product'] =="product"){
                if (isset($eltd_moose_options['woo_product_single_show_social_share'])) {
                    $product_show_social_share = $eltd_moose_options['woo_product_single_show_social_share'];

                    $product_social_share_type = "dropdown";
                    if(isset($eltd_moose_options['woo_product_single_select_share_option'])){
                        $product_social_share_type = $eltd_moose_options['woo_product_single_select_share_option'];
                    }
                }
            }
        }
...
//                    echo '<span class="socail_share_title">Share: </span>';
    ...
    add_action('eltd_woocommerce_before_related_products', 'eltd_woocommerce_share');
}