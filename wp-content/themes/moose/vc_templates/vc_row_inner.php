...
if($row_type == 'row') {
	...
	if ($enable_badge == "yes"){
		$output .= '<div class="row_badge">';
		$output .= '<span class="badge_icon"><img src="'.get_template_directory_uri().'/img/crown.png" alt=""/></span>';
		if ($badge_text !== ''){
			$output .= '<span class="badge_text">'.$badge_text.'</span>';
		}
		$output .= '<span class="row_badge_triangle"></span>';
		$output .= '</div>';
	}
	...
	if ($enable_badge == "yes"){
		...
		$output .= '<span class="row_badge_triangle"></span></div>';
	}
	...
	if($logo_in_content_menu == 'logo_in_content_menu'){
		$output .= '<div class="logo">';
			...
			if(isset($eltd_moose_options['content_menu_logo_image']) && $eltd_moose_options['content_menu_logo_image'] != ""){
				$logo_image = $eltd_moose_options['content_menu_logo_image'];
			}else if(isset($eltd_moose_options['logo_image']) && $eltd_moose_options['logo_image'] != ""){
				$logo_image = $eltd_moose_options['logo_image'];
			}
	...
	if($custom_widget_area !== ''){
		$output .= '<div class="custom_widget_area"><div class="custom_widget_area_inner"><div class="custom_widget_area_inner2">';
			$output .= eltd_moose_get_dynamic_sidebar($custom_widget_area);
		$output .= '</div></div></div>';
	}
