...
class ElatedMooseFramework {
    ...
    private function __construct() {
        $this->eltdOptions = ElatedMooseOptions::get_instance();
        $this->eltdMetaBoxes = ElatedMooseMetaBoxes::get_instance();
    }
	...
	public function setSkin(ElatedMooseSkinAbstract $skinObject) {
		$this->skin = $skinObject;
	}
}

/**
 * Class ElatedMooseSkinManager
 *
    ...
    private function setSkin($skinName = 'elated') {
        if($skinName !== '') {
            if(file_exists(get_template_directory().'/framework/admin/skins/'.$skinName.'/skin.php')) {
                ...
                $skinName = ucfirst($skinName).'MooseSkin';
...
/**
 * Class ElatedMooseSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class ElatedMooseSkinAbstract {
    /**
     * @var string
     */
    protected $skinName;
    ...
    public function getMenuIcon($icon) {
		...
		return ELATED_ROOT.'/img/favicon.ico';
	}
    ...
    public function setShortcodeJSParams() { ?>
		<script>
			window.eltdSCIcon = '<?php echo eltd_moose_get_skin_uri().'/assets/img/admin-logo-icon.png'; ?>';
...
/*
   Class: ElatedMooseAdminPage
   A class that initializes Elated Admin Page
*/
class ElatedMooseAdminPage implements iElatedMooseLayoutNode {
    ...
    function __construct($slug="", $title="", $icon = "") {
        $this->layout = array();
        $this->factory = new ElatedMooseFieldFactory();
        $this->slug = $slug;
        $this->title = $title;
        $this->icon = $icon;
    }
    ...
    public function renderChild(iElatedMooseRender $child) {
        $child->render($this->factory);
    }
}

/*
   Class: ElatedMooseMetaBoxes
...
/*
   Class: ElatedMooseMetaBox
   A class that initializes Elated Meta Box
*/
class ElatedMooseMetaBox implements iElatedMooseLayoutNode {
...
$eltdFramework = ElatedMooseFramework::get_instance();
$eltdSkinManager = new ElatedMooseSkinManager();
