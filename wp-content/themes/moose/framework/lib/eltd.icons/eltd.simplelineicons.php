...
class ElatedMooseSimpleLineIcons implements iElatedMooseIconCollection {
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = ELATED_ROOT . "/css/simple-line-icons/simple-line-icons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="eltd_icon_simple_line_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
