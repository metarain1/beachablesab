...
/**
 * Class ElatedMooseDripicons
 */
class ElatedMooseDripicons implements iElatedMooseIconCollection {
    /**
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = ELATED_ROOT . "/css/dripicons/dripicons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="eltd_icon_dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
