...
class ElatedMooseSkin extends ElatedMooseSkinAbstract {
    /**
    ...
    public function __construct() {
        ...
        //hook to
        add_action('eltd_moose_admin_scripts_init', array($this, 'registerStyles'));
        add_action('eltd_moose_admin_scripts_init', array($this, 'registerScripts'));

        add_action('eltd_moose_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('eltd_moose_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('eltd_moose_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('eltd_moose_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            eltd_moose_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        $this->styles['eltdf-moose-bootstrap'] = 'assets/css/eltdf-bootstrap.css';
        $this->styles['eltdf-moose-page-admin'] = 'assets/css/eltdf-page.css';
        $this->styles['eltdf-moose-options-admin'] = 'assets/css/eltdf-options.css';
        $this->styles['eltdf-moose-meta-boxes-admin'] = 'assets/css/eltdf-meta-boxes.css';
        $this->styles['eltdf-moose-ui-admin'] = 'assets/css/eltdf-ui/eltdf-ui.css';
        $this->styles['eltdf-moose-forms-admin'] = 'assets/css/eltdf-forms.css';
        $this->styles['eltdf-moose-import'] = 'assets/css/eltdf-import.css';
        $this->styles['eltdf-moose-font-awesome-admin'] = 'assets/css/font-awesome/css/font-awesome.min.css';

        foreach ($this->styles as $styleHandle => $stylePath) {
            eltd_moose_register_skin_style($styleHandle, $stylePath);
        }
	...
	public function setIcons() {
		$this->icons = array(
			...
			'masonry_gallery' => 'dashicons-screenoptions',
     ...
     *
*@param ElatedMooseAdminPage $page current page to load
     *
     * @see ElatedSkinAbstract::loadTemplatePart()
     */
