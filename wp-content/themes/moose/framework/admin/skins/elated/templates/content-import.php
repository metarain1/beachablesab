                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_example" id="import_example" class="form-control eltdf-form-element dependence">
                                                    <option value="moose1">Moose 1</option>
                                                    <option value="moose2">Moose 2</option>
                                                    <option value="moose3">Moose 3</option>
                                                    <option value="moose4">Moose 4</option>
                                                    <option value="moose5">Moose 5</option>
                                                    <option value="moose6">Moose 6</option>
                                                    <option value="moose7">Moose 7</option>
                                                    <option value="moose8">Moose 8</option>
                                                    <option value="moose9">Moose 9</option>
                                                    <option value="moose10">Moose 10</option>
