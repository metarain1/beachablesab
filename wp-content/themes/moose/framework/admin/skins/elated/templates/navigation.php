    ...
    <ul class="nav nav-tabs">
        ...
        foreach ($eltdFramework->eltdOptions->adminPages as $key => $page ) {
            ...
            <li<?php if ($page->slug == $tab) echo " class=\"active\""; ?>>
                <a href="<?php echo esc_url(get_admin_url().'admin.php?page=eltd_moose_theme_menu'.$slug); ?>">
                    <?php if($page->icon !== '') { ?>
        ...
        ?>
        <li <?php if($is_import_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page=eltd_moose_theme_menu_tabimport'); ?>"><i
