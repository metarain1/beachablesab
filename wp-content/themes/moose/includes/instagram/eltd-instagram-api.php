...
include(get_template_directory().'/includes/instagram/eltd-instagram-helper.php');

/**
 * Class ElatedMooseInstagramApi
 */
class ElatedMooseInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var ElatedMooseInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var ElatedMooseInstagramHelper
     */
    private $helper;
    ...
    private function __construct() {
        ...
        $this->helper = new ElatedMooseInstagramHelper();
    }
    ...
    /**
     * @return ElatedMooseInstagramApi
     */
    ...
    /**
     * @return ElatedMooseInstagramHelper
     */
