...
/**
 * Class ElatedMooseInstagramHelper
 */
class ElatedMooseInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines eltd_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('eltd_instagram_image_atts',
            array(
                'class' => $imageSize,
