...
if (!function_exists('eltd_moose_pagination')) {
	function eltd_moose_pagination($pages = '', $range = 4, $paged = 1){
		...
		$pagination_style = "";
		if ( isset($eltd_moose_options['blog_pagination_border_above_yesno']) && $eltd_moose_options['blog_pagination_border_above_yesno'] == 'yes' ){
			$pagination_classes .= " pagination_with_border";
			if ( isset($eltd_moose_options['blog_pgn_border_color']) && $eltd_moose_options['blog_pgn_border_color'] != '' ){
				$pagination_style .= "border-top-color:" . $eltd_moose_options['blog_pgn_border_color'] . "; ";
			}
			else {
				$pagination_style .= "border-top-color: #dedede; ";
			}

			if ( isset($eltd_moose_options['blog_pgn_border_width']) && $eltd_moose_options['blog_pgn_border_width'] != '' ){
				$pagination_style .= "border-top-width:" . $eltd_moose_options['blog_pgn_border_width'] . "px; ";
			}
			else {
				$pagination_style .= "border-top-width: 1px; ";
			}

			if ( isset($eltd_moose_options['blog_pgn_border_style']) && $eltd_moose_options['blog_pgn_border_style'] != '' ){
				$pagination_style .= "border-top-style:" . $eltd_moose_options['blog_pgn_border_style'] . "; ";
			}
			else {
				$pagination_style .= "border-top-style: solid; ";
			}

			if ( isset($eltd_moose_options['blog_pagination_border_margin']) && $eltd_moose_options['blog_pagination_border_margin'] != '' ){
				$pagination_style .= "padding-top:" . $eltd_moose_options['blog_pagination_border_margin'] . "px; ";
			}
			else {
		...
		if(1 != $pages){
			...
			echo "<div class='pagination ".esc_attr($pagination_classes)."' ".eltd_moose_get_inline_style($pagination_style)."><ul>";

			$icon_first_left_html =  "<span class='pagination_arrow arrow_carrot-2left'></span>";
			if (isset($eltd_moose_options['pagination_double_arrows_type']) && $eltd_moose_options['pagination_double_arrows_type'] != '') {
				$icon_navigation_class = $eltd_moose_options['pagination_double_arrows_type'];
