...
if(!function_exists('eltd_moose_get_portfolio_image_meta')) {
	function eltd_moose_get_portfolio_image_meta($image_src) {
		global $wpdb;
...
if (!function_exists('eltdMooseComparePortfolioImages')) {
	/**
	 ...
	 */
	function eltdMooseComparePortfolioImages($a, $b){
...
if (!function_exists('eltdMooseComparePortfolioOptions')){
	/**
	 ...
	 * @return int result of comparison
	 */
	function eltdMooseComparePortfolioOptions($a, $b){
