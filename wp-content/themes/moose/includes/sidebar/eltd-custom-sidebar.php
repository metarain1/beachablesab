...
if( ! class_exists('eltd_moose_sidebar') ){
	
	class eltd_moose_sidebar{
		...
		function __construct(){
			...
			$this->title = __('Custom Widget Area','eltd');
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".__('Enter Name of the new Widget Area', 'eltd')."' name='eltd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".__('Add Widget Area', 'eltd')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars(){
			...
			$args = apply_filters('eltd_custom_widget_args', $args);
