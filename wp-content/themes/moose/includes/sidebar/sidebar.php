...
if(!function_exists('eltd_moose_register_sidebars')) {
    /**
     * Function that registers theme's sidebars
     */
    function eltd_moose_register_sidebars() {
        global $eltd_moose_options;
        $centered_logo = false;

        if (isset($eltd_moose_options['center_logo_image'])){ if($eltd_moose_options['center_logo_image'] == "yes") { $centered_logo = true; }};
		...
		if((isset($eltd_moose_options['header_bottom_appearance']) && $eltd_moose_options['header_bottom_appearance'] == "stick_with_left_right_menu") ||  $centered_logo == true){
			register_sidebar(array(
    ...
    add_action('widgets_init', 'eltd_moose_register_sidebars');
}

if(!function_exists('eltd_moose_add_support_custom_sidebar')) {
    /**
     * Function that adds theme support for custom sidebars. It also creates eltd_moose_sidebar object
     */
    function eltd_moose_add_support_custom_sidebar() {
        add_theme_support('eltd_moose_sidebar');
        if (get_theme_support('eltd_moose_sidebar')) new eltd_moose_sidebar();
    }

    add_action('after_setup_theme', 'eltd_moose_add_support_custom_sidebar');
}