...
class Elated_Instagram_Widget extends WP_Widget {
    private $params;
    ...
    public function widget($args, $instance) {
        ...
        $instagram_api = ElatedMooseInstagramApi::getInstance();
        ...
        if(is_array($images_array) && count($images_array)) { ?>
            <ul class="eltd_instagram_feed clearfix col_<?php echo esc_attr($number_of_cols); ?>">
            <?php
            foreach ($images_array as $image) { ?>
                <li>
                    <a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
                        <?php echo eltd_moose_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
                    </a>
                </li>
            <?php } ?>
            </ul>
...
function eltd_instagram_widget_load(){
    register_widget('Elated_Instagram_Widget');
}
