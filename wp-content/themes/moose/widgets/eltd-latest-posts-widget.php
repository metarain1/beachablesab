...
class Elated_Latest_Posts extends WP_Widget {
	private $params;
	public function __construct() {
		parent::__construct(
			'eltd_latest_posts_widget', // Base ID
			'Elated Blog', // Name
			array( 'description' => __( 'Display posts from your blog', 'eltd' ), ) // Args
		);
...
function eltd_latest_posts_widget_load(){
	register_widget('Elated_Latest_Posts');
}

add_action('widgets_init', 'eltd_latest_posts_widget_load');