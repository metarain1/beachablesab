...
if(is_array($portfolio_tags) && count($portfolio_tags)) {
	...
	<div class="info portfolio_single_tags clearfix">
		<<?php echo esc_attr($portfolio_info_tag);?> class="info_section_title" <?php eltd_moose_inline_style($portfolio_info_style); ?>><?php _e('Tags', 'eltd') ?></<?php echo esc_attr($portfolio_info_tag);?>>
		<span class="category">
