...
if (isset($eltd_moose_options['blog_standard_type_show_categories'])){
	$blog_show_categories = $eltd_moose_options['blog_standard_type_show_categories'];
}

$blog_show_comments = "yes";
if (isset($eltd_moose_options['blog_standard_type_show_comments'])){
    $blog_show_comments = $eltd_moose_options['blog_standard_type_show_comments'];
}
$blog_show_author = "yes";
if (isset($eltd_moose_options['blog_standard_type_show_author'])){
    $blog_show_author = $eltd_moose_options['blog_standard_type_show_author'];
}
$blog_show_like = "yes";
if (isset($eltd_moose_options['blog_standard_type_show_like'])) {
    $blog_show_like = $eltd_moose_options['blog_standard_type_show_like'];
}
$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (isset($eltd_moose_options['blog_standard_type_show_ql_mark'])) {
    $blog_show_ql_icon_mark = $eltd_moose_options['blog_standard_type_show_ql_mark'];
}
...
$blog_show_date = "yes";
if (isset($eltd_moose_options['blog_standard_type_show_date'])) {
    $blog_show_date = $eltd_moose_options['blog_standard_type_show_date'];
}
$blog_show_social_share = "no";
$blog_social_share_type = "dropdown";
if(isset($eltd_moose_options['blog_standard_type_select_share_option'])){
	$blog_social_share_type = $eltd_moose_options['blog_standard_type_select_share_option'];
}
if (isset($eltd_moose_options['enable_social_share'])&& ($eltd_moose_options['enable_social_share']) =="yes"){
    if (isset($eltd_moose_options['post_types_names_post'])&& $eltd_moose_options['post_types_names_post'] =="post"){
        if (isset($eltd_moose_options['blog_standard_type_show_share'])&& $blog_social_share_type == "dropdown") {
            $blog_show_social_share = $eltd_moose_options['blog_standard_type_show_share'];
        }
    }
}

$blog_ql_background_image = "yes";
...
if (isset($eltd_moose_options['blog_standard_type_read_more_button_icon']) && $eltd_moose_options['blog_standard_type_read_more_button_icon'] == 'yes'){
    $blog_read_more_button_classes .= 'with_icon';
}


$blog_image_size = 'full';
if( isset($eltd_moose_options['blog_standard_type_image_size']) && $eltd_moose_options['blog_standard_type_image_size'] !== '') {
    $blog_image_size = 'eltd-moose-'.$eltd_moose_options['blog_standard_type_image_size'];

}

if( $blog_image_size == 'custom'
    && isset($eltd_moose_options['blog_standard_type_image_size_height']) && $eltd_moose_options['blog_standard_type_image_size_height'] !== ''
    && isset($eltd_moose_options['blog_standard_type_image_size_width']) && $eltd_moose_options['blog_standard_type_image_size_width'] !== '') {

    $image_height = $eltd_moose_options['blog_standard_type_image_size_height'];
    $image_width = $eltd_moose_options['blog_standard_type_image_size_width'];
                    ...
                    <div class="post_text_inner">         
						...
						<?php if($blog_show_author == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
								...
								<?php eltd_moose_post_info(array('like' => $blog_show_like)); ?>
							</div>
						<?php } ?>
						<?php
							the_content();
							eltd_moose_read_more_button('blog_standard_type_read_more_button',$blog_read_more_button_classes);
						?>
						<?php if(isset($eltd_moose_options['blog_standard_type_show_share']) && $eltd_moose_options['blog_standard_type_show_share'] == "yes" && $blog_social_share_type == "list") {
