...
if (isset($eltd_moose_options['blog_single_navigation']) && $eltd_moose_options['blog_single_navigation'] == "yes"){
    $enable_blog_navigation = true;
}

$navigation_blog_through_category = false;
if (isset($eltd_moose_options['blog_navigation_through_same_category']) && $eltd_moose_options['blog_navigation_through_same_category'] == "yes")
